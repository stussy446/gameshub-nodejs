(() => {
  ...
  var createNewGame = async (name, rating, length, platform) => {
    platform = platform.split(",");
    const body = { name, rating, length, platform };
    console.log(body);
    const res = await axios_default.post("http://localhost:3001/games", body, axiosConfig).then((res2) => {
